...
export function analyze(rows){
  ...
  return{date:rows[n].date,close,prev,change,volume:v[n],volAvg:vol[n]||0,volumeRatio,ema20:e20[n],ema50:e50[n],ema200:e200[n],sma20:ma20[n],sma50:ma50[n],rsi:rs[n],macd:mc.m[n],signal:mc.s[n],hist:mc.h[n],atr:at[n],atrPct,roc:ro[n],obv:ob[n],adx:di.adx[n],pdi:di.pdi[n],mdi:di.mdi[n],superTrend:sup.st[n],superTrendDir:sup.dir[n],trend,money,momentum,pattern,risk,potential,confidence,finalScore,decision,target1,target2,stop,formation,positives,negatives,ohlcv:rows}
}
