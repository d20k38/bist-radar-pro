...
module.exports = { SYMBOLS, fetchOHLCV, fetchQuote, indicators, scoreFromIndicators, master, clamp, diagnose, diagnoseMany, providerInfo: { primary:yahooFinance2?'yahoo-finance2':'none', fallback:'yahoo-http-chart', decision:'R19 AI Decision Engine' } };
